...
Then select the "Privacy" option. Factory data reset will be the last option under "Privacy."
Click that, and then press the "Reset Phone" button.

![android](img/Android%20factory%20reset.png "width:200px")
